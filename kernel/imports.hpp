...
//#define print(text, ...) DbgPrintEx(DPFLTR_IHVBUS_ID, 0, "omega -> " text, ##__VA_ARGS__)

inline VOID
print(_In_ PCCH Format, ...)
{
	CHAR Message[512];
	va_list VaList;
	...
	//vDbgPrintExWithPrefix("omega -> ", DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, Message, VaList);
#endif
